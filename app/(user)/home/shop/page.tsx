...
export default function ProductList() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#D9EAFD] via-white to-[#BFDFFF] overflow-hidden">
      <div className="container mx-auto max-w-[90%] p-4 pb-24 pt-20 md:pt-32">
